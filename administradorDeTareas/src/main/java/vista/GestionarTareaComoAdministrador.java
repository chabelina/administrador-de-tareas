...
public class GestionarTareaComoAdministrador extends javax.swing.JFrame {
  ...
  public GestionarTareaComoAdministrador() {
    ...
    table_tareas.setBackground(Color.red);
  }
  ...
  private void initComponents() {
    ...
    table_tareas.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
    ...
    table_tareas.setModel(new javax.swing.table.DefaultTableModel(
      ...
      new String [] {
        "ID", "Nombre de la Tarea", "Descripción ", "Estado", "Prioridad", "Fecha Limite", "Responsable"
      }
    ));
    ...
    if (table_tareas.getColumnModel().getColumnCount() > 0) {
      table_tareas.getColumnModel().getColumn(0).setHeaderValue("ID");
      table_tareas.getColumnModel().getColumn(1).setHeaderValue("Nombre de la Tarea");
      table_tareas.getColumnModel().getColumn(2).setHeaderValue("Descripción ");
      table_tareas.getColumnModel().getColumn(3).setHeaderValue("Estado");
      table_tareas.getColumnModel().getColumn(4).setHeaderValue("Prioridad");
      table_tareas.getColumnModel().getColumn(5).setHeaderValue("Fecha Limite");
      table_tareas.getColumnModel().getColumn(6).setHeaderValue("Responsable");
    }
